...
<body>
    ...
    <div class="left-column">
      <div class="form-container">
            <h2>Editar Autor</h2>
            <form id="authorForm" action="updateAuthor.php" method="post">
            ...
            <div class="form-group">
                 ...
                 <input type="text" id="id_usuario" name="id_usuario" placeholder= "idUserMod">
            </div>
            <div class="form-group">
    ...
    function searchAuthor() {
        ...
        if (selectedAuthor !== '') {
            fetch('readAuthor.php?autor=' + encodeURIComponent(selectedAuthor))
                ...
                .then(data => {
                    document.getElementById('tablaAutor').innerHTML = data;
                })
                .catch(error => {
